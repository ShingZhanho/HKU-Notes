...
\textbf{\emph{head [-n N] file} \hfill First N lines of file}\\
\quad \textit{Default: first 10 lines}\\
\textbf{\emph{tail [-n N] file} \hfill Last N lines of file}\\
\quad \textit{Default: last 10 lines}
...
\textbf{\emph{grep [-E|-P <regexpr> | pattern] [-o] file/stdin} \\\hfill Search for pattern}\\
\quad -E <regexpr> \hfill \textit{Match regular expression}\\
\quad -P <regexpr> \hfill \textit{Full Perl-compatible regex}\\
