\pdfmapfile{=CascadiaCode.map}

\usetikzlibrary{shapes,positioning,arrows,fit,calc,graphs,graphs.standard}

\definecolor{myblue}{cmyk}{1,.60,0,.16}
...
\renewcommand{\emph}[1]{\textbf{\textcolor{myblue}{#1}}}
...
\newcommand{\bq}{\textasciigrave} % backquote
\newcommand{\sq}{\textquotesingle} % single quote
\newcommand{\bs}{\textbackslash} % backslash

\newcommand{\eg}{{\footnotesize\itshape e.g. }}
