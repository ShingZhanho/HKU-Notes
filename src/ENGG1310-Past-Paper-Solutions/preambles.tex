...
% =============================================================
\newcommand{\primaryTag}[2]{\tcPrimaryTag{\footnotesize\bfseries\sffamily\raisebox{-0.1ex}{#1}}\index{#2}}
\newcommand{\secondaryTag}[3]{\tcSecondaryTag{\footnotesize\sffamily\raisebox{-0.1ex}{#1}}\index{#2!#3}}
...
\makeindex[title=By-topic Index,columns=1]