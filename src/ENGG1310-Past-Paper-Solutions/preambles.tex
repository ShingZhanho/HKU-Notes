...
\AfterEndEnvironment{solution}{\vspace*{-1.5em}\dotfill}
...
\newenvironment{enumroman}{
	\begin{enumerate}[label=(\roman*),labelwidth=*,leftmargin=*]
}{
	\end{enumerate}
}
\newenvironment{enumlalpha}{
	\begin{enumerate}[label=(\alph*),labelwidth=*,leftmargin=*]
}{
	\end{enumerate}
}
\newenvironment{enumualpha}{
	\begin{enumerate}[label=(\Alph*),labelwidth=*,leftmargin=*]
}{
	\end{enumerate}
}
\newenvironment{enumarab}{
	\begin{enumerate}[label=(\arabic*),labelwidth=*,leftmargin=*]
}{
	\end{enumerate}
}
...
\newcommand{\ignorePageNum}[1]{}
\newcommand{\primaryTag}[2]{\tcPrimaryTag{\footnotesize\bfseries\sffamily\raisebox{-0.15ex}{#1}}}
\newcommand{\secondaryTag}[3]{\tcSecondaryTag{\footnotesize\sffamily\raisebox{-0.15ex}{#1}}\expanded{\noexpand\index{#2!#3|qref{\currentQLabel}{\currentQRef}}}}
