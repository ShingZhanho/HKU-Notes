...
\begin{tikzpicture}
    % Root
        ...
        % Second layer
        \node (c11) at (-7.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c12) at (-6.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c13) at (-5.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c14) at (-4.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c21) at (-3.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c22) at (-2.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c23) at (-1.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c24) at (-0.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c31) at ( 0.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c32) at ( 1.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c33) at ( 2.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c34) at ( 3.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c41) at ( 4.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c42) at ( 5.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c43) at ( 6.5,-4) {\footnotesize $f(n/b^2)$};
        \node (c44) at ( 7.5,-4) {\footnotesize $f(n/b^2)$};
        ...
        % Right column
        \node (l1_sum) at (10, 0) {$f(n)$};
        \node (l2_sum) at (10, -2) {\(a \cdot f(n/b)\)};
        \node (l3_sum) at (10, -4) {\(a^2 \cdot f(n/b^2)\)};
        \node (base_sum) at (10, -6.5) {$\Theta(n^p)$};
