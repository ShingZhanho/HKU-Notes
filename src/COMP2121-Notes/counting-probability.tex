...
\begin{theorem}[$r$-Permutations with Repetitions]
...
\begin{theorem}[Combinations with Repetitions]
...
\begin{corollary}[Permutations of Indistinguishable Objects]
...
\begin{corollary}[Generalised Pigeonhole Principle]
...
\begin{example}[Application of Pigeonhole Principle]
...
\begin{definition}[Probability of Subsets]
...
\begin{definition}[Uniform Probability Distribution]
...
\begin{definition}[Equal Probability Assumption]
