...
\begin{lemma}[Disjoint Sets]\label{lem:disjoint-sets}
...
\begin{definition}[Big-$\bigO$ Notation]
...
\begin{definition}[Big-$\bigOmg$ Notation]
...
\begin{theorem}[Duality of Big-$\bigO$ and Big-$\bigOmg$]
...
\begin{definition}[Big-$\bigTh$ Notation]
