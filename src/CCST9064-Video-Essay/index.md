...
<iframe width="560" height="315" src="https://www.youtube.com/embed/7meTbcns6Tg?si=ayVX3-LLnrAFqLM-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

If the video is not displayed properly, please use the button above to view on YouTube.
...
Please ensure that you have the required dependencies installed.

To build the animations, do:

```bash
pip install -r requirements.txt         # Install dependencies
manim -qh [SCRIPT_NAME]                 # Render the animation in high quality,
...
Below is a preview of the research log:
