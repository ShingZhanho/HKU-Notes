...
It has been established that the euphemism treadmill is a powerful engine to keep the coporate jargon in fashion, nevertheless, it was more about a generalised audience.
...
This tool consists of multi-layered linguistic manupilations, from lexical to sociolinguistic and psycholinguistic levels, that work together to achieve the major purposes of control and healing.

Inherently, the corporate jargon was created for the sake of efficient communication in corporate life, through features such as brevity and abbreviations \parencite{Kapralikova2024}, norminalisation \parencite{Bailey1997}, \textit{et cetera}.
These features aim to create a shared langauge that is efficient, objective, professional, and agent-neutral.
In certain contexts, when applied approriately, corporate jargon is indeed a useful tool of verbal communication.
However, when the jargon is deployed soley for obfuscation, it can easily become a weapon that alienates different audiences, either intentionally or unintentionally.
