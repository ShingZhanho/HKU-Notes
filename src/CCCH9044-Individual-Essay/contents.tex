...
as a set of tools utilising Machine Learning (ML), Convolutional Neural Networks (CNNs), and Large
Language Models (LLMs) dedicated to the analysis and processing of images and texts for the purpose of
