...
\newcommand{\lIff}{\leftrightarrow}
    \newcommand{\liff}{\lIff}
\newcommand{\lTV}[1]{\text{w(}#1\text{)}} % Truth value of a proposition
    \newcommand{\ltv}{\lTV}
...
\newcommand{\mtset}{\emptyset} % Empty set
...
\makeatletter
\renewenvironment{proof}[1][\proofname] {\par\pushQED{\textbf{\hfill Q.E.D.}}{\normalfont\sffamily\bfseries\topsep6\p@\@plus6\p@\relax #1\@addpunct{.}\par }}{\par\popQED\endtrivlist\@endpefalse}
\makeatother
