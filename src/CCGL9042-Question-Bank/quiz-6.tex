...
\begin{parts}
    ...
    \begin{solution}
        ...
        greater \% of its population living in extreme poverty ($\sim$40\%) in comparison to the world average
        ($\sim$10\%). The ratio of the world's people not living in extreme poverty versus the world's people living
    ...
    \part In the last two decades, the world Gini coeﬃcient
    ...
    \begin{solution}
        Slide ``Gini coeﬃcient'' showing the graph reveals that the Gini coeﬃcient has fallen for the last 2 decades.
    \end{solution}
    ...
    \begin{choices}
        ...
        \choice The eﬀect of inflation on GDP growth rate cannot be adjusted.
