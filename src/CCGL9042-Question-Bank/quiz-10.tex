...
\begin{parts}
    ...
    \begin{choices}
        ...
        action.
        \choice Sea level will continue to rise up to a decade or so after $\text{CO}_2$ emissions stop.
        \choice Domesticated crops such as wheat were bred at the pre-industrial $\text{CO}_2$ level of around
        270 ppm, thus their yields will fall as $\text{CO}_2$ level rises above that level.
    ...
    \begin{choices}
        \choice The amount of fossil fuel used is not consistent with $\text{CO}_2$ added to the atmosphere.
        \correctchoice To motivate mitigation, governments can implement $\text{CO}_2$ dividends.
        ...
        \choice The rise of sea level will stop when $\text{CO}_2$ emissions stop.
    \end{choices}
    ...
    \begin{choices}
        ...
        \choice Sea level rise will stop when $\text{CO}_2$ emissions stop.
    ...
    \begin{solution}
        ...
        sea level will not stop when $\text{CO}_2$ emissions stop; the rise will continue for centuries after $\text{CO}_2$
    ...
    \begin{solution}
        Slide ``What will $\text{CO}_2$ level be?'' shows that a freeze in the rate of $\text{CO}_2$ emission would
        lead to a level of about 770 ppm in 2100. Since $\text{CO}_2$ emission has been rising for the last 7 decades,
    ...
    \begin{choices}
        ...
        \choice eﬃcient, one-party government.
    ...
    \begin{solution}
        ...
        interest but are not trained to compare the costs and benefits of solutions in diﬀerent areas. That is what economists do.
