...
High-achieving Computer Science student (CGPA 3.80) with a passion for software development and problem-solving.
Experience in C++ and Python development through coursework and projects with a strong background in leadership as a Teaching Assistant.
Eager to contribute technical skills to a dynamic software development team.
...
\cvevent{Summer Intern}{Airport Authority Hong Kong}{Jun 2026 -- Aug 2026}{Hong Kong International Airport}
\begin{itemize}
  \item Developed a desktop application with Python independently to automate the monthly billing process, reducing the need of manual verification work and saving 90\% of time.
  \item Built a web application with Python backend and React frontend to centralise the weekly audit tasks, deployed on Google Cloud, integrated with rigid security and authentication measures, and improved the efficiency of the audit process by 50\%.
\end{itemize}

\divider

\cvevent{Student Teaching Assistant}{The University of Hong Kong}{Sept 2025 -- Jun 2026}{Hong Kong}
\begin{itemize}
  \item Led weekly tutorials for students for the course COMP2113 (Computer Programming II) to help students with their C++ programming skills
  \item Answered students' questions and provided feedback on their assessments and projects
...
\begin{itemize}
  ...
  \item Collaborated in a team of 6 through experienced usage of Git and GitHub, including basic version control and clear contribution guidelines, branch protection strategies, etc.
  \item Utilised GitHub Actions for CI/CD to automate testing and building for maintaining code quality from team members
\end{itemize}
}
...
\cvevent{B.Eng.\ in Computer Science}{The University of Hong Kong}{Sept 2024 -- Current}{}
\begin{itemize}
  \item CGPA: 3.80/4.30
\end{itemize}
...
\cvevent{M.B., B.S.\ {\footnotesize (Transferred)}}{The University of Hong Kong}{Sept 2023 -- Mar 2024}{}
\begin{itemize}
  \item Pass in all assessment components (GPA system not applicable to the medicine programme)
  \item Withdrawn and transferred to pursue his true passion in Computer Science
\end{itemize}
...
\textcolor{emphasis}{\textbf{Cantonese}}\hfill Native

\divider

\textcolor{emphasis}{\textbf{Mandarin}}\hfill Professional
...
\begin{itemize}
  \item Minor in French, A+ in both FREN1001 and FREN1002, A in FREN2001
  \item DELF A2 98.5/100
  \item Expected completion of B1 by end of 2026
\end{itemize}
