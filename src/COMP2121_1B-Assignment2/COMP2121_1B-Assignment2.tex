...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            Denote the path as a $(a+b)$-sequence of the set $\{U,R\}$, where $U$ denotes moving upwards
            ...
            Thus, \fbox{there are $\binom{a+1}{b}$ ways in total to reach the point from the origin}.
        \end{solution}
