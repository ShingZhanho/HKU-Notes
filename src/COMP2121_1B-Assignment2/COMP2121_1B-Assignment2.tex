    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \begin{align*}
                ...
                f_{g_1}(2) &= g_1(g_1(n-1))\big|_{n=2} = g_1(2n-1)\big|_{n=2} = 4n+1\big|_{n=2} = 9,\\
                f_{g_1}(3) &= g_1(4n+1)\big|_{n=3} = 8n+3\big|_{n=3} = 27,\\
                f_{g_1}(4) &= g_1(8n+3)\big|_{n=4} = 16n+7\big|_{n=4} = 71,\\
                f_{g_1}(5) &= g_1(16n+7)\big|_{n=5} = 32n+15\big|_{n=5} = 175,\\
                &\cdots
            \end{align*}
