...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \end{align*}
            When $m$ and $n$ are constants, $\card{A\cap B\cap C}$ is minimum when $\card{A\cap B}
            =\card{A\cap C}=\card{B\cap C}=0$.
            In such case, $A$, $B$, and $C$ are mutually disjoint. Then, $m$ is simply:
            \[
                m=\card{A\cup B\cup C}=\card{A}+\card{B}+\card{C}=n+n+n=3n.
            \]
            Thus, $\boxed{\min \card{A\cup B\cup C} = m-3n = 3n-3n = 0}$.
        \end{solution}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \end{align*}
            and $P(\text{truth}=\text{non-spam})=\frac{17}{18}$.
            ...
            \begin{align*}
                ...
                &\qquad+\left[P(\text{output}=\text{non-spam}\mid\text{label}=\text{spam}) P(\text{truth}=\text{spam})\right.\\
                &\qquad\qquad+ \left.P(\text{output}=\text{spam}\mid\text{label}=\text{non-spam}) P(\text{truth}=\text{non-spam})\right] \cdot 0.05 \\
                &=\left[0.8\cdot\frac{1}{18} + 0.9\cdot\frac{17}{18}\right]\cdot0.95 + \left[0.2\cdot\frac{1}{18} + 0.1\cdot\frac{17}{18}\right]\cdot0.05 \\
                &=\frac{3059}{3600}+\frac{19}{3600} \\
                &= \boxed{\frac{3078}{3600}=0.855}.
            \end{align*}
        \end{solution}
