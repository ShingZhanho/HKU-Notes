...
class MetadataV1Parser(MetadataParserBase):
    ...
    def parse(self) -> Metadata:
        ...
        self.parsed_obj.static_site__primary_button__href = self.json_obj.get("static_site", {}).get("primary_button", {}).get("href", f"https://hku.jacobshing.com/HKU-Notes/files/{self.parsed_obj.name}/{self.parsed_obj.output_file}")
